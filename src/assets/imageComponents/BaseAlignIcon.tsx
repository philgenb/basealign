...
export const BaseAlignIcon: React.FC<Props> = ({className}) => {
    return (
        <svg className={className} width="94" height="94" viewBox="0 0 94 94" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0_16_2)">
                <path
                    ...
                    stroke="#EDD64D" strokeWidth="6.87901"/>
            </g>
            ...
            <g mask="url(#mask1_16_2)">
                <path
                    ...
                    stroke="#7B96E8" strokeWidth="6.87901"/>
            </g>
            ...
            <g mask="url(#mask2_16_2)">
                <path
                    ...
                    stroke="#525A71" strokeWidth="6.87901"/>
            </g>
            <defs>
