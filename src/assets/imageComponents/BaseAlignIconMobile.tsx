...
export const BaseAlignIconMobile: React.FC<Props> = ({className}) => {
    return (
        <svg
            className={className}
            width="94"
        ...
        >
            ...
            <mask id="mask0_mobile" maskUnits="userSpaceOnUse" x="30" y="48" width="34" height="20">
                <rect
                    x="30.715"
                    y="48.7633"
                    width="32.6753"
            ...
            <mask id="mask1_mobile" maskUnits="userSpaceOnUse" x="30" y="28" width="10" height="21">
                <rect
                    x="30.715"
                    y="28.3578"
                    width="9.0287"
            ...
            <mask id="mask2_mobile" maskUnits="userSpaceOnUse" x="42" y="34" width="22" height="15">
                <rect
                    x="42.3234"
                    y="35.005"
                    width="21.067"
