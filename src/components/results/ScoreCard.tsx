...
export const ScoreCard: React.FC<ScoreCardProps> = ({
  ...
  return (
    <div className="p-6 bg-white rounded-2xl border border-card shadow-card flex flex-col items-center">
      <div className="text-gray-400 font-semibold mb-2">Overall Score</div>
