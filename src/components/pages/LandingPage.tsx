...
import {autoResizeTextarea, CodeEditor, useIsMac} from "../input/CodeEditor";
...
const LandingPage: React.FC = () => {
    ...
    // Global paste: expand editor and insert clipboard when outside inputs
    useEffect(() => {
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-16">
                ...
                {!expanded && (
                    <div className="mt-4 text-center text-sm text-black/50">
                        Press {isMac ? "⌘" : "Ctrl"}+V to paste your code and expand the
                        editor
                    </div>
                )}
            </div>
