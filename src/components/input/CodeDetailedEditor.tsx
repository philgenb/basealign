...
const Keycap: React.FC<React.PropsWithChildren> = ({children}) => (
  <span className="inline-flex items-center justify-center rounded-md border px-2 py-1 text-xs font-medium shadow-sm bg-white/80 border-black/10">
    {children}
  </span>
);
...
export const CodeEditorMonaco: React.FC<CodeEditorProps> = ({
  ...
  return (
    <motion.div
      ref={containerRef}
      tabIndex={0} /* focusable so paste/typing events reach us */
      layout
